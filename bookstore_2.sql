...
INSERT INTO [Book]
       VALUES
	        (1, 3, '978-5-17-083520-1', 2019, 5000, 391),
					...
					(3, 4, '978-5-4467-3088-9', 2016, 10000, 555),
					(4, 3, '978-5-04-116479-9', 2014, 3000, 400),
					...
					(8, 5, '978-5-04-108626-8', 2021, 3500, 700),
					(10, 2, '978-5-17-106123-4',2019, 2000, 480);
...
INSERT INTO [Employee]
       VALUES
	        ('Пищиков', 'Павел', 'Григорьевич', 1, 1, '02.11.1997'),
					('Косарёв', 'Валерий', 'Романович', 1, 1, '12.01.1997'),
					('Летавина', 'Елизавета', 'Феоктистовна', 1, 2, '12.01.1995'),
					('Ясеневский', 'Герасим', 'Степанович', 2, 1, '12.03.1965'),
					('Загряжский', 'Аркадий', 'Федорович', 1, 1, '12.06.1962'),
					('Куксюк', 'Константин', 'Германович', 1, 2, '12.02.2000'),
					('Майсак', 'Нонна', 'Феодосьевна', 1, 3, '12.01.1987'),
					('Аверина', 'Светлана', 'Трофимовна', 1, 2, '12.01.1965'),
					('Агеев', 'Ефим', 'Трофимович', 2, 5, '13.05.1987'),
					('Сухов', 'Илья', 'Герасимович', 2, 1, '17.06.1993'),
					('Рыбаков', 'Дмитрий', 'Дмитрий', 2, 3, '01.03.1993'),
					('Манякина', 'Катерина', 'Наумовна', 2, 1, '02.11.1993'),
					('Воликов', 'Роман', 'Семенович', 2, 2, '12.12.1999'),
					('Яковкин', 'Валерий', 'Прокопьевич', 2, 1, '12.09.1987'),
					('Бабанина', 'Ольга', 'Леонтьевна', 2, 1, '12.01.1993'),
					('Чадова', 'Елена', 'Юрьевна', 2, 4, '12.01.1987'),
					('Щербатых', 'Ева', 'Ефремовна', 3, 5, '12.02.1987'),
					('Занин', 'Леонид', 'Давидович', 3, 1, '12.03.1993'),
					('Рутберг', 'Степан', 'Игнатьевич', 3, 4, '12.07.1987'),
					('Яровая', 'Ася', 'Никифоровна', 3, 1, '12.03.1993'),
					('Фарест', 'Клавдия', 'Федоровна', 3, 5, '12.05.1987'),
					('Кинжаев', 'Яков', 'Савванович', 3, 5, '12.01.1993');
...
INSERT INTO [Promotion]
       VALUES
	        ('Почитай старших', '12.12.2021', '12.01.2022', 1, 1, 15),
					...
					('Почитай старших', '12.12.2021', '12.01.2022', 3, 2, 15),
					('Почитай старших', '12.12.2021', '12.01.2022', 8, 1, 15),
					('Почитай старших', '12.12.2021', '12.01.2022', 8, 2, 15),
					('Почитай старших', '12.12.2021', '12.01.2022', 5, 3, 15),
					('Почитай старших', '12.12.2021', '12.01.2022', 7, 1, 15);
